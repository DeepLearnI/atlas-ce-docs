...
The contents of the current working directory are copied to a working directory and mounted inside the Worker. 
The results are then archived to an archive location that can be accessed using the CLI.     
